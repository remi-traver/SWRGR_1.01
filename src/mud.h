...
typedef struct  pol_data                POL_DATA;
...
/*
 * Subclass defines (by Raijen) borrowed from SWL code base
 */
...
#define SUBCLASS_WFOCUS		4 /*Fighter Pilot*/
#define SUBCLASS_ADVBLAST	5 /*Weaponsmith pt1*/
#define SUBCLASS_WEAPONSMITH    5
#define SUBCLASS_ADVARMOR	6 /*Tailor pt1*/
#define SUBCLASS_TAILOR         6
#define SUBCLASS_QUICKWORK	7
#define SUBCLASS_JACKOFTRADES   8
#define SUBCLASS_SNEAK  	9 /*Thief*/
#define SUBCLASS_STEALTH_HUNT	10 /*Assassin*/
#define SUBCLASS_OFFICER	11
#define SUBCLASS_SENATOR	12
#define SUBCLASS_BLADEMASTER    13 /*Swordsman*/
#define SUBCLASS_DOCTOR          14
#define SUBCLASS_PARAMEDIC       15
#define SUBCLASS_SOLDIER         16
#define SUBCLASS_MECHANIC        17
#define SUBCLASS_SURVIVOR        18         
#define SUBCLASS_FORCE_SENSITIVE 19
#define SUBCLASS_JEDI            20
#define SUBCLASS_PRODIGY         21
#define SUBCLASS_SITH_HUNTER     22
#define SUBCLASS_FALSE_PROPHET   23
#define SUBCLASS_JURYRIGGER      24
#define SUBCLASS_GENIUS          25
#define SUBCLASS_MERCENARY       26
#define SUBCLASS_MEDIC           27
...
#define MEDICAL_ABILITY     8
#define CONTROL_ABILITY    FORCE_ABILITY
#define ALTER_ABILITY      FORCE_ABILITY
#define SENSE_ABILITY      FORCE_ABILITY


#define CLASS_COMBAT      0
#define CLASS_PILOT       1
#define CLASS_ENGINEERING 2
#define CLASS_HUNTING     3
#define CLASS_SMUGGLING   4
#define CLASS_LEADERSHIP  5
#define CLASS_DIPLOMACY   6
#define CLASS_MEDICAL     7
#define CLASS_FORCE       8
#define CLASS_ESPIONAGE   9
#define CLASS_CHEMIST     10
#define CLASS_SCOUNDREL   11
#define CLASS_AMBASSADOR  12
#define CLASS_SCOUT       13
#define CLASS_SNITCH      14
#define CLASS_COMMANDO    15
#define CLASS_MAX         16
...
SHIP_DOCK, SHIP_DOCK_2, SHIP_DOCK_3
} ship_states;
typedef enum
{ MISSILE_READY, MISSILE_FIRED, MISSILE_RELOAD, MISSILE_RELOAD_2, MISSILE_DAMAGED } missile_states;
typedef enum
{ FIGHTER_SHIP, MIDSIZE_SHIP, FRIGATE_SHIP, CAPITAL_SHIP, SUPERCAPITAL_SHIP, SHIP_PLATFORM, MOBILE_SUIT, CLOUD_CAR, OCEAN_SHIP, LAND_SPEEDER, WHEELED, LAND_CRAWLER,
WALKER
} ship_classes;
typedef enum
...
/* Politic States, by Arcturus */
#define POL_NEUTRAL    0 /* Neutral */
#define POL_UNFRIENDLY 1 /* Nearing War */
#define POL_FRIENDLY   2 /* Peaceful/Beneficial */
#define POL_ATWAR      3 /* At War */
#define POL_ALLY       4 /* Friendly, Ally */
#define POL_MAX        5 /* This just makes it easier to expand, if I have to. */

/* Rank Flags, By Arcturus */
#define RANK_LEADER       BV00
#define RANK_OFFICER      BV01
#define RANK_WITHDRAW     BV02
#define RANK_PILOT        BV03
#define RANK_CLANBUYSHIP  BV04
#define RANK_CLANSELLSHIP BV05
#define RANK_INDUCT       BV06
#define RANK_OUTCAST      BV07
#define RANK_PROMOTE      BV08
#define RANK_DEMOTE       BV09
#define RANK_EMPOWER      BV10
#define RANK_ROSTER       BV11
#define RANK_LOCKED       BV12
#define RANK_FLAGS        13

struct   rank_data
{
    CLAN_DATA* clan;
    short sn;   /* sn in table */
    short slot; /* Unchangeable SN */
    short authority; /* Actual rank authority */
    char* name;  /* Name of rank */
    int    flags; /* Flags of rank */
    int    wage;  /* Wages of rank */
};

#define ADD_ROSTER    1
#define REMOVE_ROSTER 0

struct roster_data
{
    CLAN_DATA* clan;
    ROSTER_DATA* next_roster;
    ROSTER_DATA* prev_roster;
    char* name;
    short  rank;
    short  sn;
};
...
#define MOB_VNUM_ELITE_NR  30
#define MOB_VNUM_SUPERMOB 3
#define MOB_VNUM_ESTORMTROOPER 35
#define MOB_VNUM_EIMP_GUARD    36
#define MOB_VNUM_ENR_GUARD     37
#define MOB_VNUM_ENR_TROOPER   38
#define MOB_VNUM_NR_PATROL     39
#define MOB_VNUM_NR_EPATROL    40
#define MOB_VNUM_IMP_PATROL    41
#define MOB_VNUM_IMP_EPATROL   42

#define MOB_VNUM_RI_GUARD      43
#define MOB_VNUM_RI_EGUARD     47
#define MOB_VNUM_RI_PATROL     45
#define MOB_VNUM_RI_EPATROL    48
#define MOB_VNUM_RI_TROOPER    44
#define MOB_VNUM_RI_ETROOPER   46
...
/*
* /Spell flags	The minimum BV *MUST* be 11!
*/
...
#define WEAPON_NONE     	0 /*hit*/
#define WEAPON_VIBRO_AXE	1 /*slice*/
#define WEAPON_VIBRO_BLADE	2 /*stab*/
#define WEAPON_LIGHTSABER	3 /*slash*/
#define WEAPON_FLAMETHROWER 4 /*burst of flames*/
#define WEAPON_CLAW	    	5 /*slash*/
#define WEAPON_BLASTER		6 /*blast*/
#define WEAPON_SLUGTHROWER  7 /*shot*/
#define WEAPON_BLUDGEON		8 /*crush*/
#define WEAPON_BOWCASTER    9 /*shot*/
#define WEAPON_SWORD        10 /*slash*/
#define WEAPON_FORCE_PIKE	11 /*pierce*/
#define WEAPON_VIBRO_SWORD  12 /*slash*/
#define WEAPON_WHIP         13 /*lashing*/
...
typedef enum
{
   ...
   APPLY_FULL, APPLY_THIRST, APPLY_DRUNK, APPLY_BLOOD, APPLY_SNIPERWEAPON,
   MAX_APPLY_TYPE, APPLY_RESEARCHTARGET, APPLY_DUCK
} apply_types;
...
#define PCFLAG_DISGUISED        BV12
#define PCFLAG_BOUNTY_SPEC        BV13 /* Bounty level reward requested by Soul */
#define PCFLAG_HIDE_SKILLS         BV14 /* Hide force skills on the prac list */
#define PCFLAG_SPARRING            BV15
...
struct char_data
{
   ...
   short fstyle;
   short evasive_skill;
   short agressive_skill;
   short offensive_skill;
   short defensive_skill;
   short force_roll;
   short bonus_attacks;
   short num_fighting;
   short substate;
   ...
   short main_ability;
   short subclass; /*added from SWL code */
   short sniperweapon;
   OBJ_DATA *supermob;
   short cmd_recurse;
...
struct pc_data
{
   ...
   const char *disguisename;
   int clanlevel;
   int status; //honour status
   short rank_sn;
   ...
   short item_skill[MAX_SKILL]; /* Skills from items */
   short item_bonus[MAX_SKILL];
...
struct room_index_data
{
   ...
   CHAR_DATA *first_watcher;
   CHAR_DATA *last_watcher;
   OBJ_DATA *first_content;
   OBJ_DATA *last_content;
   EXTRA_DESCR_DATA *first_extradesc;
   EXTRA_DESCR_DATA *last_extradesc;
...
extern short gsn_frigates;
extern short gsn_capitalships;
extern short gsn_supercapitalships;
...
extern short gsn_burn;
extern short gsn_overdrive;
extern short gsn_evade;
extern short gsn_cloak;
extern short gsn_docking;
...
extern short gsn_researchtarget;
...
extern short gsn_makebludgeon;
extern short gsn_makejewelry;
extern short gsn_makeblaster;
extern short gsn_makeforcepike;
...
extern short gsn_doublelightsaber_crafting;
extern short gsn_spice_refining;
extern short gsn_makesword;
extern short gsn_negotiate;
extern short gsn_repairitem;
...
extern short gsn_tuck;
extern short gsn_seal;
extern short gsn_slide;
extern short gsn_combat_reflexes;
extern short gsn_force_reflexes;
extern short gsn_subclasses;
...
extern short gsn_besiege;
extern short gsn_flushpoison;
extern short gsn_bind;
extern short gsn_trace_comlink;
...
extern short gsn_slugthrowers;
extern short gsn_doublelightsabers;
extern short gsn_whip;
extern short gsn_bludgeons;
extern short gsn_unarmed;
extern short gsn_swords;
extern short gsn_vibroaxes;
extern short gsn_flamethrowers;
extern short gsn_scrapattack;
...
extern const char *const attack_table[WEAPON_MAX];
...
extern const char *const weapon_table[WEAPON_MAX];
...
extern const char *const subclasses[SUBCLASS_MAX];
...
DECLARE_DO_FUN( do_force_roll);
DECLARE_DO_FUN( do_force_rollaward );
...
void remove_bexit_flag       args((EXIT_DATA* pexit, int flag));
...
void    load_roster             args(());
void    save_roster             args((CLAN_DATA* clan));
void    fread_roster            args((ROSTER_DATA* roster, FILE* fp));
void    update_roster           args((CHAR_DATA* ch, int action));
ROSTER_DATA* get_roster         args((CHAR_DATA* ch));
void    initialize_roster       args((CLAN_DATA* clan));
...
void skill_use_xp args((CHAR_DATA *ch, int sn));
//int get_skill_percent args((CHAR_DATA *ch, int sn));
//bool knows_skill args((CHAR_DATA *ch, int sn));
...
void start_watching  args((CHAR_DATA* ch, ROOM_INDEX_DATA* room));
void stop_watching   args((CHAR_DATA* ch));
...
bool    check_save      args((int sn, int level, CHAR_DATA * ch, CHAR_DATA * victim));
