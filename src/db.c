...
short gsn_throw;
short gsn_addpatrol;
short gsn_elitepatrol;
short gsn_flushpoison;
...
short gsn_doublelightsaber_crafting;
short gsn_spice_refining;
short gsn_makeblade;
short gsn_makebludgeon;
short gsn_makesword;
...
short gsn_repairitem;
short gsn_makeforcepike;
short gsn_scrapattack;
...
short gsn_unarmed;
short gsn_swords;
short gsn_slugthrowers;
short gsn_vibroaxes;
short gsn_flamethrowers;
...
short gsn_slide;
short gsn_seal;
short gsn_trace_comlink;
short gsn_researchtarget;
...
short gsn_kick;
short gsn_parry;
short deflect;       /* Not yet installed */
short gsn_rescue;
...
short gsn_aware;
short gsn_combat_reflexes;
short gsn_force_reflexes;
...
void boot_db( bool fCopyOver )
{
    ...
    */
   {
      ...
      ASSIGN_GSN( gsn_elitepatrol, "elite_patrol" );
      ...
      ASSIGN_GSN( gsn_makebludgeon, "makebludgeon" );
      ASSIGN_GSN( gsn_makesword, "makesword" );
      ...
      ASSIGN_GSN( gsn_repairitem, "repairitem" );
      ...
      ASSIGN_GSN( gsn_doublelightsaber_crafting, "doublelightsaber crafting" );
      ...
      ASSIGN_GSN( gsn_slugthrowers, "slugthrowers" );
      ...
      ASSIGN_GSN( gsn_blackjack, "blackjack" );
      ASSIGN_GSN( gsn_cheap, "cheap" );
      ...
      ASSIGN_GSN( gsn_trace_comlink, "trace comlink" );
      ...
      ASSIGN_GSN( gsn_negotiate, "negotiate" );
      ...
      ASSIGN_GSN( gsn_scrapattack, "scrapattack" );
      ...
      ASSIGN_GSN( gsn_makeforcepike, "makeforcepike" );
      ASSIGN_GSN( gsn_flushpoison, "flushpoison" );
      ASSIGN_GSN( gsn_bind, "bind" );
      ASSIGN_GSN( gsn_burn, "burn" );
      ASSIGN_GSN( gsn_sabotage, "sabotage" );
      ASSIGN_GSN( gsn_overdrive, "overdrive" );
      ASSIGN_GSN( gsn_evade, "evade" );
      ASSIGN_GSN( gsn_cloak, "cloak" );
      ASSIGN_GSN( gsn_researchtarget, "research_target" );
      ASSIGN_GSN( gsn_vibroaxes, "axes" );
      ASSIGN_GSN( gsn_flamethrowers, "flamethrowers" );
      ASSIGN_GSN( gsn_deflect, "deflect" );
      ASSIGN_GSN( gsn_palm, "palm" );
      ASSIGN_GSN( gsn_tuck, "tuck" );
      ASSIGN_GSN( gsn_slide, "slide");
      ASSIGN_GSN(gsn_seal, "seal");
      ASSIGN_GSN( gsn_aware, "situational_awareness");
      ASSIGN_GSN(gsn_combat_reflexes, "combat reflexes");
      ASSIGN_GSN(gsn_force_reflexes, "force reflexes");
   }
...
void load_room_reset( ROOM_INDEX_DATA *room, FILE *fp )
{
   ...
   switch( letter )
   {
      ...
      case 'O':
         if( get_obj_index( arg1 ) == NULL && fBootDb )
            boot_log( "%s: %s (%d) '%c': object %d doesn't exist.", __func__, room->area->filename, count, letter, arg1 );
         break;
      ...
      case 'P':
         ...
         if( arg3 <= 0 )
            arg3 = OBJ_VNUM_MONEY_ONE; // This may look stupid, but for some reason it works.
         if( get_obj_index( arg3 ) == NULL && fBootDb )
            boot_log( "%s: %s (%d) 'P': destination object %d doesn't exist.", __func__, room->area->filename, count, arg3 );
         if( extra > 1 )
            not01 = TRUE;
         break;
...
OBJ_DATA *create_object( OBJ_INDEX_DATA * pObjIndex, int level )
{
   ...
   {
      default:
         bug( "%s: vnum %d bad type: %d.", __func__, pObjIndex->vnum, obj->item_type );
         break;
...
char *stripclr( char* text)
{
    ...
    else
    {
        ...
        buf[j] = '\0';
        sprintf(done, "%s", buf);
        buf = (char *)realloc(buf, j * sizeof(char));  //error: invalid conversion from ‘void*’ to ‘char*’ [-fpermissive] added (Char *) before void realloc
        free(buf); 
